...
bg = pygame.image.load("image/tetris/photo_1.jpg").convert()
game_bg = pygame.image.load("image/tetris/photo_2.jpg").convert()
...
def set_record(record2, score):
    rec = max(int(record2), score)
    with open('record', 'w') as f:
        f.write(str(rec))
